		...
		setAttributes( {
			checkmarks: [
				...checkmarks,
				{
					...
					data_aos_delay: '',
					title: '',
					content: `<div style="width:15px;height:15px;background:var(--accent-primary);border-radius:50%;padding:7px;" class="d-flex align-items-center justify-content-center">
					<svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1170.21 1145.48">
  <g id="Layer_1-2" data-name="Layer 1">
    <g id="OHQcBN.tif">
