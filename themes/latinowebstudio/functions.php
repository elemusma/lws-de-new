...
function chevronRight() {
	...
	<g id="Layer_1-2" data-name="Layer 1">
	  <g>
		<path class="" fill="var(--accent-primary)" d="M406.65,201.47c12.5,12.5,12.5,32.8,0,45.3l-192,192c-12.5,12.5-32.8,12.5-45.3,0s-12.5-32.8,0-45.3l169.4-169.4L169.45,54.67c-12.5-12.5-12.5-32.8,0-45.3s32.8-12.5,45.3,0l192,192-.1.1Z"/>
		<path class="" fill="var(--accent-primary)" d="M246.68,201.47c12.5,12.5,12.5,32.8,0,45.3L54.68,438.77c-12.5,12.5-32.8,12.5-45.3,0s-12.5-32.8,0-45.3l169.4-169.4L9.47,54.67C-3.03,42.17-3.03,21.88,9.47,9.38s32.8-12.5,45.3,0l192,192-.1.1Z"/>
	  </g>
	</g>
  </svg>';
}
    ...
    <section class="position-relative text-white bg-black" style="padding:100px 0px;" id="inspection">
      ...
      <div class="container">
        <div class="row justify-content-center">
          ...
          <?php if(is_page(17)) { ?>
      <h1 class="text-shadow" style="box-shadow:inset 0 -5px 0 0 var(--accent-primary);display:inline-block;">Free Pre-Inspection or Appraisal Consultation</h1>
      <?php } else { ?>
        <h2 class="text-shadow" style="box-shadow:inset 0 -5px 0 0 var(--accent-primary);display:inline-block;">Free Pre-Inspection or Appraisal Consultation</h2>
        <?php } ?>
      <p class="text-shadow">Don&apos;t risk costly repairs or hidden damage know the truth before you buy with certified inspections and appraisals.</p>
