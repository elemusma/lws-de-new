...
// <!-- The first Modal -->
echo '<div id="leadMagnetModal" class="modal-custom" style="display:none;">';
echo '<div class="modal-content-custom d-flex align-items-center position-relative">';
echo '<span class="close-custom position-absolute" style="top:25px;right:25px;">&times;</span>';

echo '<div class="row">';
echo '<div class="col-lg-6 d-none d-md-block">';
echo wp_get_attachment_image(1482,'full','',array(
    'class'=>'w-100',
    'style'=>'height:100%;object-fit:cover;'
));
echo '</div>';
echo '<div class="col-lg-6 col-md-9 col-12">';
echo '<h2 class="h3">How to Choose the Right Expert Witness Without Wasting Time or Risking Your Case</h2>';
