...
<div class="card bg-light d-lg-block d-none" style="border:2px solid #eaeaea;padding:15px;border-radius:25px;">
...
<div>
  ...
  <g id="Layer_1-2" data-name="Layer 1">
    <g>
      ...
      <path fill="white" class="" d="M795.13,443l291.99,427,368.44-427h99.49l-421.99,492.43,458.99,669.57h-338.97l-309.95-451-387.48,451h-99.49l442.82-516.33L456.16,443h338.97ZM1455.06,1533l-709.43-1015h-153.48l709.43,1015h153.48Z"/>
...
<div class="card text-white d-lg-block d-none" style="background: #272727;
background: linear-gradient(45deg, rgba(39, 39, 39, 1) 0%, rgba(20, 20, 20, 1) 30%, rgba(163, 29, 33, 1) 80%, rgba(218, 47, 53, 1) 100%);padding:15px;border-radius:25px;">
	<?php 
	// echo do_shortcode('[new_patient_special]'); 
	?>
	<h2 class="" style="margin-top:0px;font-size:21px;">Buy With Confidence</h2>
	<h3 class="" style="margin-top:0px;font-size:16px;">Pre-Inspection &amp; Appraisal</h3>
	<div class="divider" style="margin-left:0;"></div>
  <ul class="small sidebar-cta" style="">
    <li>Hands-On Expert Evaluations</li>
    <li>Same-Day Detailed Reports</li>
    <li>100+ Photos, Video, Diagnostics</li>
    <li>Trusted Across All Vehicle Types</li>
    <li>Veteran-Owned</li>
</ul>
